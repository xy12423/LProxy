...
class SocksService : public ProxyService
{
public:
	SocksService(ProxyServer &server, asio::io_context &ioContext, const endpoint &acceptorLocalEp) :ProxyService(server, ioContext, acceptorLocalEp) {}
protected:
